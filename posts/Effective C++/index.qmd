...
So `static_cast` is safe only when the conversion is logically valid.
If the programmer gets it wrong, C++ will not stop you, it'll be undefined behavior though. Some valid usecases are as:
