...
::: {.callout-note}
Here Scott Meyers also proposed a method to pass the responsibility to the client/user to manually handle if such things happen. I don't know, I am don't happily agree to it. But nevertheless point to be note is that, a destructor should not throw an exception, its a very bad design.
:::
