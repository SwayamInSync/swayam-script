...
| :----------: | :------: | :----------------------------------------------------------: |
|  Conjunction  | $\wedge$ |    True if both P and Q propositions are true, else False    |
| disjunction  |  $\vee$  |    True if either of P and Q is true or both, else False     |
|   negation   |  $\neg$  |                    Negates the proposition                    |
...
- $\lnot (p_1 \wedge p_2 \wedge p_3 \wedge ..) \equiv (\lnot p_1 \vee \lnot p_2 \vee \lnot p_3 \vee ...)$
...
- **Some logical equivalence involving conditional statements**
...
- **Some logical equivalence involving Biconditional statements**
...
$$
[(p_1 \vee p_2 \vee ... \vee p_n ) \implies q] \equiv [(p_1 \implies q) \wedge (p_2 \implies q) \wedge ... \wedge(p_n \implies q)]
$$
...
![checkerboard](assets/chapter-1/checkerboard.png)
...
> 
> ![](assets/chapter-1/checkerboard-opposite-corner-removed.png){width=40% fig-align="center"}
>
...
>
> ![](assets/chapter-1/triomino.png){width=30% fig-align="center"}
>
> *Solution:* So lets color the checkerboard with 3 alternative colors, blue, black and white as shown in figure below
>
> ![](assets/chapter-1/checkerboard-tricolor.png){width=60% fig-align="center"}
>
